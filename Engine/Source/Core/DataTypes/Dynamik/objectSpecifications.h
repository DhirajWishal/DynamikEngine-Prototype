...
namespace Dynamik {
	...
	enum class DMKFormat {
		...
		DMK_FORMAT_RGBA_ASTC_4X4_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_4X4_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_5X4_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_5X4_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_5X5_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_5X5_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_6X5_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_6X5_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_6X6_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_6X6_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X5_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X5_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X6_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X6_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X8_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_8X8_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X5_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X5_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X6_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X6_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X8_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X8_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X10_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_10X10_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_12X10_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_12X10_SRGB_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_12X12_UNORM_BLOCK16,
		DMK_FORMAT_RGBA_ASTC_12X12_SRGB_BLOCK16,

		DMK_FORMAT_RGB_PVRTC1_8X8_UNORM_BLOCK32,
		DMK_FORMAT_RGB_PVRTC1_8X8_SRGB_BLOCK32,
		DMK_FORMAT_RGB_PVRTC1_16X8_UNORM_BLOCK32,
		DMK_FORMAT_RGB_PVRTC1_16X8_SRGB_BLOCK32,
		DMK_FORMAT_RGBA_PVRTC1_8X8_UNORM_BLOCK32,
		DMK_FORMAT_RGBA_PVRTC1_8X8_SRGB_BLOCK32,
		DMK_FORMAT_RGBA_PVRTC1_16X8_UNORM_BLOCK32,
		DMK_FORMAT_RGBA_PVRTC1_16X8_SRGB_BLOCK32,
		DMK_FORMAT_RGBA_PVRTC2_4X4_UNORM_BLOCK8,
		DMK_FORMAT_RGBA_PVRTC2_4X4_SRGB_BLOCK8,
		DMK_FORMAT_RGBA_PVRTC2_8X4_UNORM_BLOCK8,
		DMK_FORMAT_RGBA_PVRTC2_8X4_SRGB_BLOCK8,
	};
	...
	enum class DMKVertexData {
		...
		DMK_VERTEX_DATA_UV_COORDINATES,				// UV coordinates
		...
		DMK_VERTEX_DATA_BONE_WEIGHTS,				// Bond weights
		DMK_VERTEX_DATA_BONE_ID,					// Bond ID
