#pragma once
#ifndef _DYNAMIK_CENTRAL_DATA_HUB_TYPE_CHECK_H
#define _DYNAMIK_CENTRAL_DATA_HUB_TYPE_CHECK_H
 ...
 */
#define DMK_STATIC_TYPE_CHECK(TYPE_1, TYPE_2, MSG)	static_assert(!::Dynamik::isType<TYPE_1, TYPE_2>::result, MSG)

#endif // !_DYNAMIK_CENTRAL_DATA_HUB_TYPE_CHECK_H
