	...
	namespace Renderer {
		namespace Backend {
			...
			void VulkanBRDF::_initializeRenderPass()
			{
				...
				VulkanRenderPassInitInfo initInfo;
			...
			{
				VulkanGraphicsFrameBufferInitInfo initInfo;
			...
			{
				VulkanDescriptorSetLayoutInitInfo initInfo;
			...
			{
				VulkanGraphicsPipelineLayoutInitInfo initInfo;
			...
			{
				VulkanGraphicsShaderInitInfo VSinitInfo;
				VSinitInfo.path = "Shaders/BRDF/vert.spv";
				VSinitInfo.type = VulkanGraphicsShaderType::ADGR_VULKAN_SHADER_TYPE_VERTEX;
				VulkanGraphicsShader vertShader;
				vertShader.initialize(logicalDevice, VSinitInfo);

				VulkanGraphicsShaderInitInfo FSinitInfo;
				FSinitInfo.path = "Shaders/BRDF/frag.spv";
				FSinitInfo.type = VulkanGraphicsShaderType::ADGR_VULKAN_SHADER_TYPE_FRAGMENT;
