#pragma once
#ifndef _DYNAMIK_RENDERER_VULKAN_BIDIRECTIONAL_REFLECTANCE_DESTRIBUTION_FUNCTION_H
#define _DYNAMIK_RENDERER_VULKAN_BIDIRECTIONAL_REFLECTANCE_DESTRIBUTION_FUNCTION_H
...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {
			...
			public:
				VulkanBRDF() {}
				VulkanBRDF(VulkanGraphicsSupportObjectInitInfo info) :
...
#endif // !_DYNAMIK_RENDERER_VULKAN_BIDIRECTIONAL_REFLECTANCE_DESTRIBUTION_FUNCTION_H
