	...
	namespace Renderer {
		namespace Backend {
			...
			public:
				...
				static void updateBoundingBox(VkDevice device, DMKUniformBufferData uniformData, VkDeviceMemory uniformBufferMemory, MeshVertexLimits limits, VEC3 location, B1 shouldRender);
