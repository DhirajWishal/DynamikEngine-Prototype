#pragma once
#ifndef _DYNAMIK_RENDERER_VULKAN_COMPUTE_BUFFER_OBJECT_H
#define _DYNAMIK_RENDERER_VULKAN_COMPUTE_BUFFER_OBJECT_H
	...
	namespace Renderer {
		namespace Backend {
			...
			public:
				...
				VulkanComputeBufferObject(VulkanComputeObjectInitInfo info) : VulkanComputeObject(info) {}
...
#endif // !_DYNAMIK_RENDERER_VULKAN_COMPUTE_BUFFER_OBJECT_H
