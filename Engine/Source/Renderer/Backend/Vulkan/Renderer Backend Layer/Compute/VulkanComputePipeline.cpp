...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {		
			void VulkanComputePipeline::initializePipelineLayout(VkDevice device, VulkanGraphicsPipelineLayoutInitInfo info)
			{
			...
			void VulkanComputePipeline::initializePipeline(VkDevice device, VulkanComputePipelineInitInfo info)
			{
