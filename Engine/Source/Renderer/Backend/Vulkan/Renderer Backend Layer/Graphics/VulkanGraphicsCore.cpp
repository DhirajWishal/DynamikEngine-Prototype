...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {
			...
			void VulkanGraphicsCore::initializeInstance(VulkanInstanceInitInfo info)
			{
			...
			VulkanQueue VulkanGraphicsCore::findQueueFamilies(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface)
			{
				VulkanQueue indices;
