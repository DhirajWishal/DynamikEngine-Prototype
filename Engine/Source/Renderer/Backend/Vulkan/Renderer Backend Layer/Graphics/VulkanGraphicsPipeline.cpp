...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {
			void VulkanGraphicsPipeline::initializePipelineLayout(VkDevice device, VulkanGraphicsPipelineLayoutInitInfo info)
			{
			...
			void VulkanGraphicsPipeline::initializePipeline(VkDevice device, VulkanGraphicsPipelineInitInfo info)
			{
