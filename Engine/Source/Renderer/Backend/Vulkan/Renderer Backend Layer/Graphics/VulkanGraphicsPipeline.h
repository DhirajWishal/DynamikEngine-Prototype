#pragma once
#ifndef _DYNAMIK_RENDERER_VULKAN_GRAPHICS_PIPELINE_H
#define _DYNAMIK_RENDERER_VULKAN_GRAPHICS_PIPELINE_H
	...
	namespace Renderer {
		namespace Backend {
			...
			public:
				...
				virtual void initializePipelineLayout(VkDevice device, VulkanGraphicsPipelineLayoutInitInfo info);
				virtual void initializePipeline(VkDevice device, VulkanGraphicsPipelineInitInfo info);
