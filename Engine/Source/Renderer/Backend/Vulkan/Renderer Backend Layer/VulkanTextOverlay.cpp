...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {
			VulkanTextOverlay::VulkanTextOverlay(VulkanTextOverlayInitInfo info)
			{
			...
			void VulkanTextOverlay::setResources(VulkanTextOverlayInitInfo info)
			{
				myCoreObject = info.mainCore;
			...
			{
				VulkanGraphicsCommandBufferInitInfo info;
			...
			void VulkanTextOverlay::_initializePipeline()
			{
				...
				//VulkanGraphicsRenderableObjectInitInfo objInitInfo;
			...
			void VulkanTextOverlay::_localCommandBuffer::initializeCommandBuffers(VulkanGraphicsCommandBufferInitInfo info)
			{
				...
				for (size_t i = 0; i < size; i++) {
					...
					for (VulkanRenderData _data : info.objects)
					{
