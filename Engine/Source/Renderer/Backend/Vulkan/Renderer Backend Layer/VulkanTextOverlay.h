#pragma once
#ifndef _DYNAMIK_RENDERER_VULKAN_TEXT_OVERLAY_H
#define _DYNAMIK_RENDERER_VULKAN_TEXT_OVERLAY_H

#include "Renderer/Backend/Components/TextOverlay.h"
...
namespace Dynamik {
	namespace Renderer {
		namespace Backend {
			struct VulkanTextOverlayInitInfo {
			...
			public:
				VulkanTextOverlay(VulkanTextOverlayInitInfo info);
				VulkanTextOverlay() {}
				~VulkanTextOverlay() {}

				void setResources(VulkanTextOverlayInitInfo info);
			...
			private:
				...
				public:
					...
					void initializeCommandBuffers(VulkanGraphicsCommandBufferInitInfo info) override;
...
#endif // !_DYNAMIK_RENDERER_VULKAN_TEXT_OVERLAY_H
