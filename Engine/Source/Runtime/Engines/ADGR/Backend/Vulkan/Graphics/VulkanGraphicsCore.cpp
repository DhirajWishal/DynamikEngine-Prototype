	...
	namespace ADGR {
		namespace Backend {
			...
			B1 isDeviceSuitable(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface) {
				...
				{
					VulkanGraphicsSwapChainSupportDetails swapChainSupport = VulkanGraphicsCore::querySwapChainSupport(physicalDevice, surface);
			...
			VulkanGraphicsSwapChainSupportDetails VulkanGraphicsCore::querySwapChainSupport(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface)
			{
