	...
	namespace ADGR {
		namespace Backend {
			...
			public:
				...
				void addInitializedAnimation(VkDevice logicalDevice, POINTER<InternalFormat> _object, VkSampleCountFlagBits msaaSamples, VulkanGraphicsRenderableObject* animation);
