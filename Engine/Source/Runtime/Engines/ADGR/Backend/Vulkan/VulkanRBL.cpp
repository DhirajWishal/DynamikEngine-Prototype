...
namespace Dynamik {
	namespace ADGR {
		...
		VPTR VulkanRBL::initializeObject(POINTER<InternalFormat> format)
		{
			...
			ADGRVulkanRenderData _renderData;
		...
		ADGRVulkanBufferContainer VulkanRBL::createVertexBuffer(Mesh mesh, ARRAY<DMKVertexAttribute> attributes)
		{
		...
		ADGRVulkanBufferContainer VulkanRBL::createIndexBuffer(Mesh mesh, DMKDataType type)
		{
			ADGRVulkanBufferContainer _container;
		...
		ADGRVulkanTextureContainer VulkanRBL::createTextureImage(Texture texture)
		{
		...
		ADGRVulkanUnformBufferContainer VulkanRBL::createUniformBuffers(DMKUniformBufferObjectDescriptor uniformBufferDescriptor)
		{
		...
		VulkanGraphicsDescriptor VulkanRBL::createDescriptors(ARRAY<DMKUniformBufferObjectDescriptor> descriptors, ARRAY<ADGRVulkanUnformBufferContainer> uniformBufferContainers, ARRAY<ADGRVulkanTextureContainer> textureContainers)
		{
		...
		VulkanGraphicsPipeline VulkanRBL::createPipeline(ARRAY<VulkanGraphicsDescriptor> descriptors, ARRAY<DMKUniformBufferObjectDescriptor> uniformBufferDescriptors, ARRAY<DMKVertexAttribute> attributes, ShaderPaths paths, DMKObjectType objectType)
		{
			...
			ADGRVulkanGraphicsPipelineLayoutInitInfo layoutInitInfo;
