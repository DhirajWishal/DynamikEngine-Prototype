...
namespace Dynamik {
	namespace ADGR {
		UBO_MP CameraSkybox::updateCamera(std::deque<DMKEventContainer> container, DMKUpdateInfo updateInfo)
		{
			...
			uboVS.proj = glm::perspective(glm::radians(90.0f), updateInfo.aspectRatio, 0.001f, 256.0f);
