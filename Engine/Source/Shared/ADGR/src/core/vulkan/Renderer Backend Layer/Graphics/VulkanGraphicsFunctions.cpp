...
namespace Dynamik {
	namespace ADGR {
		namespace Backend {
			void VulkanGraphicsFunctions::createBuffer(VkDevice logicalDevice, VkPhysicalDevice physicalDevice, ADGRVulkanCreateBufferInfo info)
			{
			...
			UI32 VulkanGraphicsFunctions::findMemoryType(UI32 typeFilter, VkMemoryPropertyFlags properties, VkPhysicalDevice physicalDevice)
			{
			...
			VkSampleCountFlagBits VulkanGraphicsFunctions::getMaxUsableSampleCount(VkPhysicalDevice physicalDevice)
			{
			...
			B1 VulkanGraphicsFunctions::hasStencilComponent(VkFormat format)
			{
				return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
			}

			VkFormat VulkanGraphicsFunctions::findSupportedFormat(const ARRAY<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features, VkPhysicalDevice physicalDevice)
			{
			...
			VkFormat VulkanGraphicsFunctions::findDepthFormat(VkPhysicalDevice physicalDevice)
			{
			...
			void VulkanGraphicsFunctions::createImage(VkDevice logicalDevice, VkPhysicalDevice physicalDevice, ADGRVulkanCreateImageInfo info)
			{
			...
			VkImageView VulkanGraphicsFunctions::createImageView(VkDevice device, ADGRVulkanCreateImageViewInfo info)
			{
			...
			VkSampler VulkanGraphicsFunctions::createImageSampler(VkDevice logicalDevice, ADGRVulkanTextureSamplerInitInfo info)
			{
			...
			ADGRVulkanUnformBufferContainer VulkanGraphicsFunctions::createUniformBuffers(VkDevice logicalDevice, VkPhysicalDevice physicalDevice, VkDeviceSize bufferSize, UI32 count)
			{
