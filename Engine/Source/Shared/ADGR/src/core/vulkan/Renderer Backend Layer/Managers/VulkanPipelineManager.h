	...
	namespace ADGR {
		namespace Backend {
			...
			public:
				...
				void initialize(POINTER<VulkanCoreObject> core, ADGRVulkanPipelineInitInfo info, POINTER<VulkanRenderObject> object);
				void terminate(POINTER<VulkanCoreObject> core, POINTER<VulkanRenderObject> object);
			};
		}
	}
}
