...
namespace Dynamik {
	namespace ADGR {
		namespace Backend {
			void VulkanPipeline::initializePipelineLayout(VkDevice device, ADGRVulkanPipelineLayoutInitInfo info)
			{
			...
			void VulkanPipeline::initializePipeline(VkDevice device, ADGRVulkanPipelineInitInfo info)
			{
			...
			void VulkanPipeline::terminate(VkDevice device)
			{
