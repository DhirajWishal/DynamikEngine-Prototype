	...
	namespace ADGR {
		namespace Backend {
			...
			public:
				...
				virtual void initializePipelineLayout(VkDevice device, ADGRVulkanPipelineLayoutInitInfo info);
				virtual void initializePipeline(VkDevice device, ADGRVulkanPipelineInitInfo info);
