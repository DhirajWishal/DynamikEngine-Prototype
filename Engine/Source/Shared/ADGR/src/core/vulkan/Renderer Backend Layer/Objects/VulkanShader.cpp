...
namespace Dynamik {
	namespace ADGR {
		namespace Backend {
			void VulkanShader::initialize(VkDevice logicalDevice, ADGRVulkanShaderInitInfo info)
			{
				type = info.type;
			...
			void VulkanShader::terminate(VkDevice logicalDevice)
			{
				vkDestroyShaderModule(logicalDevice, shaderModule, nullptr);
			}

			VkShaderModule VulkanShader::createShaderModule(VkDevice logicalDevice, ARRAY<CHR> code)
			{
